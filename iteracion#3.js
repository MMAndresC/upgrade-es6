...
console.log('La array:', pointsList);
console.log('Copia:', copyPointsList);

//3.2 Dado el siguiente objeto, crea una copia usando spread operators.
const toy = {name: 'Bus laiyiar', date: '20-30-1995', color: 'multicolor'};
const copyToy = {...toy};
console.log('El objeto original:', toy);
console.log('La copia:', copyToy);

//3.3 Dado los siguientes arrays, crea un nuevo array juntandolos usando 
//spread operatos.
const pointsList1 = [32, 54, 21, 64, 75, 43];
const pointsList2 = [54,87,99,65,32];
const supremePointsList = [...pointsList1, ...pointsList2];
console.log('1º array:', pointsList1);
console.log('2º array:', pointsList2);
console.log('Las dos juntas:', supremePointsList);
